...
```{r}
#install.packages('MASS') #run if not installed
library(ggplot2)
library(ggrepel)
library(ggpubr)
library(glmnet)
...
### How do each lab variable correlate with each other?
...
ggplot(results_df, aes(x = Filtered_Variables, y = Consensus_Patients)) +
  ...
  geom_text_repel(
    ...
    nudge_y = 1000, # Nudges the label upwards
  ...
  labs(
    title = "Number of Consensus Patients vs Number of Filtered Variables",
